...
//import com.toedter.calendar.JDateChooser.setDate;
...
g2D.drawString("Home Inventory Items - Page " + String.valueOf(pageIndex + 1),(int)pf.getImageableX(),(int) (pf.getImageable()+25));
// get starting y
